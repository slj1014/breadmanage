...
<body>
	...
	<div id=MainArea>
		...
		<s:form action="addRecordAction_add"
				...
				<div class="ItemBlock">
					<table cellpadding="0" cellspacing="0" class="mainForm">
						<tr>
							<td>选择面包:</td>
						 <td>
						 <s:select name="breadid" cssClass="SelectStyle"
						 headerKey="" headerValue="----请选择---"
                        		list="#breads" listKey="id" listValue="name">
                            </s:select>
						</tr>
						<tr>
						<td>零售价</td>
						 <td> 	<s:textfield name="price" cssClass="InputStyle required" />
								*</td>
						</tr>
						<tr>
							<td>数量:</td><td>
							<s:textfield name="num" cssClass="InputStyle required" />
								*</td>
						</tr>	
					</table>
            </div>
