...
<body>
	...
	<div id="MainArea">
			...
			<tbody id="TableData" class="dataContainer" datakey="breadList">
				...
				<s:iterator value="recordList">
					<tr class="TableDetail1 template">
						<td><c:formatDate value="${addtime}" pattern="yyyy-MM-dd HH:mm:ss"/></td>
						<td>${bread.name}</td>
						<td>${num}</td>
						<td>${price}&nbsp;</td>
					</tr>
		...
		<div id="TableTail" style="height:40px">
			<div id="TableTail_inside">
				<form action="${pageContext.request.contextPath}/addRecordAction_list.action">
					<table>
						<tr>
							<td>日期：</td>
	...
	<!--  打印报表-->
		<div style="height:40px;float:right;margin-top: -50px">
			<div id="TableTail_inside">
				<form action="${pageContext.request.contextPath}/addRecordAction_print.action">
					<table>
						<tr>
							<td>开始日期：</td>
	...
	<!--分页信息-->
	<s:form action="addRecordAction_list?id=%{id}">
	</s:form>
